        ...
        {loading ? (
          <React.Fragment>
            ...
            <div>
              ...
              <button className="card__fav card__desc">
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                  	 viewBox="0 0 512 512" style={{enableBackground: "new 0 0 512 512"}} width="16px" height="16px">
                  <path fill="#FFDC64" d="M492.757,190.241l-160.969-14.929L267.847,26.833c-4.477-10.396-19.218-10.396-23.694,0
                  ...
                  <path fill="#FFC850" d="M267.847,26.833c-4.477-10.396-19.218-10.396-23.694,0l-63.941,148.478L19.243,190.24
...
class FilmCard extends Component {
  render() {
    ...
    return (
      <div className="card">
        <Film isFetched={this.props.isFetched} info={info} />
      </div>
    )
  }
}
